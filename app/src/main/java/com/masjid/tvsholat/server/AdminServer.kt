...
class AdminServer (
    ...
    override fun serve(session: IHTTPSession): Response {
        ...
        android.util.Log.d("ADMIN_SERVER", ">>> [${method}] ${uri} from ${remoteIp}")
        ...
        if (!authorized) {
            ...
            response.addHeader("WWW-Authenticate", "Basic realm=\"Admin TvSholat\"")
            return response
        }
        // ------------------
    ...
    override fun start(timeout: Int, daemon: Boolean) {
        ...
        android.util.Log.d("ADMIN_SERVER", "🚀 Server jalan di port 9090")
    }
